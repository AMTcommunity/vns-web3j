package org.web3j.protocol.vns;
...
public class VnsWeb3jFactory {
    ...
    public static Web3j build(Web3jService web3jService) {
        return new VnsJsonRpc2_0Web3j(web3jService);
    }
    ...
    public static Web3j build(
        ...
        return new VnsJsonRpc2_0Web3j(web3jService, pollingInterval, scheduledExecutorService);
    }
}
